...
export const Route = createFileRoute("/_authenticated/recebimento")({
  head: () => ({ meta: [{ title: "Recebimento — Nuvem Planos" }] }),
...
function imprimirRelatorio(session: Session, items: RecebItem[]) {
  ...
  w.document.write(`<!doctype html><html><head><meta charset="utf-8"><title>Relatório de Baixa — Nuvem Planos</title>
    <style>
    ...
    <div class="brand">Nuvem Planos</div>
