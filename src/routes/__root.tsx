...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "LINHATEC — Gestão de Planos Funerários" },
      ...
      { property: "og:title", content: "LINHATEC — Gestão de Planos Funerários" },
      { name: "twitter:title", content: "LINHATEC — Gestão de Planos Funerários" },
