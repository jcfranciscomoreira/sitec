...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Nuvem Planos — Gestão de Planos Funerários" },
      ...
      { property: "og:title", content: "Nuvem Planos — Gestão de Planos Funerários" },
      { name: "twitter:title", content: "Nuvem Planos — Gestão de Planos Funerários" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;500;600;700&family=Plus+Jakarta+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;1,400&display=swap" },
    ],
  }),
